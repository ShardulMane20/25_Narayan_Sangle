...
<body class="bg-gray-100">
    ...
    <nav class="bg-green-600 p-2 shadow-lg">
        <div class="container mx-3 flex justify-between items-center">
            ...
            <a href="#" class="text-white text-lg font-bold">Smart AgriTech</a>
            <div class="hidden md:flex space-x-8 md:space-x-12 text-base font-normal">
                ...
                <a href="..\Rental_services\backend\Rental_product.php" class="text-white hover:text-gray-200">Rent Equipment</a>
        ...
        <div class="hidden mobile-menu">
            ...
            <a href="../templates/CropDisease.php" class="block text-white py-2">Rental Services</a>
    ...
    <section class="container mx-auto py-20">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <!-- Soil Testing Module -->
            <a href="../templates/Soil_Fertilizer.php" class="block p-8 bg-green-400 shadow-lg rounded-lg hover:shadow-2xl transition duration-300" style="background-image: url('../img/soil.jpg'); background-size: cover; background-position: center;">
            ...
            <a href="../templates/CropDisease.php" class="block p-8 bg-green-600 shadow-lg rounded-lg hover:shadow-2xl transition duration-300" style="background-image: url('../img/leaf.jpg'); background-size: cover; background-position: center;">
                <div class="bg-white bg-opacity-75 p-4 rounded">
