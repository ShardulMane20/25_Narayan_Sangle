            ...
            <tbody>
                ...
                <?php
                   ...
                   while ($r=mysqli_fetch_array($res)) {
                    ...
                    echo "<td>".$r[3]."</td>";
                    echo "<td>".$r[4]."</td>";
                    echo "<td><a href='shopsave.php?action=remove&owner=".$r[0]."'role='button'class='btn btn-danger'><span class='glyphicon glyphicon-trash'aria-hidden='true'></span></button></td>";
                    echo "</tr>";
